...
public class User implements Serializable
{
    ...
    public User(final String fullname, final String username, final String email,
            final String password, String fotouml)
    {
        this(fullname, username, email);
        this.fotouml = fotouml;
    ...
    public User(Long id, String username, String fullname, String email, String password/*, String fotouml*/)
    {
        super();
        this.id = id;
        this.username = username;
    ...
    public String getFotouml() 
    {
		return fotouml;
	}

	public void setFotouml(String fotouml) 
	{
		this.fotouml = fotouml;
	}

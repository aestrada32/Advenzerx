...
public class DataModule
{
    ...
    public void initialize()
    {
        ...
        users.add(new User("Christophe Cordenier", "cordenier", "ccordenier@example.com",
                "cordenier", "R2-D2.jpg"));
        users.add(new User("Katia Aresti", "karesti", "karesti@example.com", "karesti", "user_icon.png"));
...
//        tracks.add(new Track("Track1"));
//        tracks.add(new Track("Track2"));
//        tracks.add(new Track("Track3"));
//        tracks.add(new Track("Track4"));
//        tracks.add(new Track("Track5"));
